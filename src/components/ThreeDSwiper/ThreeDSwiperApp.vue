...
<style scoped>
  ...
  .SolidBox ul li div:nth-child(1){
    background: url("../../../static/image/list-w-1.jpg");
    background-size: 100% 100%;
  }
  .SolidBox ul li div:nth-child(1){
    background: url("../../../static/image/list-w-2.jpg");
    background-size: 100% 100%;
  }
  .SolidBox ul li div:nth-child(1){
    background: url("../../../static/image/list-w-3.jpg");
    background-size: 100% 100%;
  }
  .SolidBox ul li div:nth-child(1){
    background: url("../../../static/image/list-w-4.jpg");
    background-size: 100% 100%;
  }
</style>
